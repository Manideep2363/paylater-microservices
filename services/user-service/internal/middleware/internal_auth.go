...
//
// Requirements:
//   - INTERNAL_API_TOKEN must be configured (non-empty)
//   - Request must send header: X-Internal-Token: <token>
//   - Token must match INTERNAL_API_TOKEN exactly
//
// Stronger service-to-service auth may replace this in a later phase.
